...
- Use Termux side setup [ green 'termux' prompt ] - paste or type: ```container-session -o```
- Use Linux image container setup [ fuschia 'termux' prompt ] - paste or type: ```container-session -u termux``` follwed by ```container-session -o```
