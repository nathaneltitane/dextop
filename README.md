...
- Use Termux side setup - paste or type: ```container-session -o```
- Use Linux image container setup - paste or type: ```container-session -u termux``` follwed by ```container-session -o```
