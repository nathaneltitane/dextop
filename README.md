...
- It uses [console](https://github.com/nathaneltitane/terminal/console/console), a custom shell parser to handle the setup, colorize prompts and provide the user with an elegant, comprehensive and user-friendly experience.
